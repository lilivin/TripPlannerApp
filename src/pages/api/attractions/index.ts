...
export const GET: APIRoute = async ({ request, locals }) => {
  try {
    ...
    if (!parseResult.success) {
      return ApiError.validationError("Nieprawidłowe parametry zapytania", parseResult.error.format()).toResponse();
    }
...
export const POST: APIRoute = async ({ request, locals }) => {
  try {
    ...
    */
    ...
    if (!parseResult.success) {
      return ApiError.validationError("Nieprawidłowe dane atrakcji", parseResult.error.format()).toResponse();
    }
