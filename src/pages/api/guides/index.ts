  ...
  try {
    ...
    if (isTestMode) {
      ...
      if (creatorError) {
        ...
        if (creatorError.code === 'PGRST116') { // Not found
        ...
        return createErrorResponse(
          ...
          'Błąd podczas sprawdzania uprawnień twórcy'
        );
      }
        ...
        switch (serviceError.code) {
          case '23505': // Unique violation
            return createErrorResponse(
              409,
              'Conflict',
              'Przewodnik o takich parametrach już istnieje'
            );
          case '23503': // Foreign key violation
            return createErrorResponse(
              400,
              'Bad Request',
              'Nieprawidłowe odniesienie do innego zasobu'
            );
