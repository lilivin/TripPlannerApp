  ...
  return (
    ...
    >
      ...
      <div className="flex items-end space-x-2">
        <Button onClick={applyFilters} className="flex-1" aria-label="Apply filters" type="submit">
          Apply Filters
        </Button>
        <Button onClick={resetFilters} variant="outline" className="flex-1" aria-label="Reset all filters" type="reset">
          Reset
        </Button>
      </div>
    </form>
